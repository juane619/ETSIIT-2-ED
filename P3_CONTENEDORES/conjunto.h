...
public:
	...
	*/
	...
	@post no modifica el conjunto.
	*/
	conjunto::const_iterator lower_bound (const str & chr, const unsigned int & pos) const;
	...
	@post no modifica el conjunto.
	*/
	conjunto::const_iterator upper_bound (const str & chr, const unsigned int & pos) const;
